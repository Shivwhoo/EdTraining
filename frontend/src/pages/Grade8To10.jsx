...
export default function Grade8To10() {
  const boards = ['CBSE', 'ICSE', 'Karnataka', 'Maharashtra'];

  return (
    <>
      <Helmet>
        <title>Grade 8th to 10th - All Boards | EdTraining</title>
        <meta name="description" content="Academic courses for 8th to 10th Grade covering CBSE, ICSE, Karnataka, and Maharashtra boards." />
        <link rel="canonical" href="https://www.theedtraining.com/grade-8th-to-10th-all-boards" />
      </Helmet>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-20">
            <h1 className="text-4xl md:text-6xl font-serif font-black text-[#1C1C1C] mb-6 leading-tight">
              8th to 10th Grade <br className="hidden md:block"/>
              <span className="bg-[#A7F3D0] px-6 py-1 inline-block border-4 border-[#1C1C1C] shadow-[6px_6px_0px_rgba(28,28,28,1)] rotate-1 mt-4 font-mono uppercase tracking-tight">
                All Boards
              </span>
            </h1>
            <p className="text-xl text-[#4A4A4A] max-w-2xl mx-auto font-serif border-b-2 border-dashed border-[#1C1C1C] pb-8 mt-8">
              A comprehensive curriculum designed to build a strong foundation for high school students.
            </p>
          </div>
          ...
          <div className="bg-[#FEF08A] border-4 border-[#1C1C1C] p-10 md:p-16 shadow-[12px_12px_0px_rgba(28,28,28,1)] -rotate-1 text-center relative max-w-4xl mx-auto">
            ...
            <div className="mt-16 flex justify-center">
              <motion.div whileHover={{ y: -4, x: -4 }} whileTap={{ y: 2, x: 2 }} transition={{ type: "spring", stiffness: 400, damping: 10 }}>
                <Link to="/booking-a-demo-class" className="bg-[#1C1C1C] text-[#FDFBF7] px-10 py-5 text-lg font-mono font-bold uppercase tracking-wider shadow-[8px_8px_0px_rgba(251,207,232,1)] hover:shadow-[10px_10px_0px_rgba(251,207,232,1)] transition-shadow inline-block border-4 border-[#1C1C1C]">
