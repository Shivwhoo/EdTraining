      ...
      <div className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-slate">
          ...
          <div className="space-y-6 text-slate-600">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-800 mb-3">License</h2>
              ...
              <p className="font-semibold mt-4 mb-2">You must not:</p>
              <ul className="list-disc pl-5 space-y-1">
                <li>Copy or republish material from EdTraining</li>
              ...
              <p className="font-semibold mt-4 mb-2">You warrant and represent that:</p>
              <ul className="list-disc pl-5 space-y-1">
              ...
              <p className="mt-4">You hereby grant EdTraining a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats, or media.</p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-slate-800 mb-3">Hyperlinking to our Content</h2>
              ...
              <p className="font-semibold mt-4 mb-2">We may consider and approve other link requests from the following types of organizations:</p>
              <ul className="list-disc pl-5 space-y-1">
              ...
              <p className="font-semibold mt-4 mb-2">Approved organizations may hyperlink to our Website as follows:</p>
              <ul className="list-disc pl-5 space-y-1">
              ...
              <p className="mt-4">No use of EdTraining's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-800 mb-3">Reservation of Rights</h2>
              <p>We reserve the right to request that you remove all links or any particular link to our Website. You approve to immediately remove all links to our Website upon request. We also reserve the right to amend these terms and conditions and its linking policy at any time. By continuously linking to our Website, you agree to be bound to and follow these linking terms and conditions.</p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-slate-800 mb-3">Removal of links from our website</h2>
