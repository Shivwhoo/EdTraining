      ...
      <div className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-slate">
          ...
          <div className="space-y-6 text-slate-600">
            <p>EdTraining website is owned by EdMentor, which is a data controller of your personal data.</p>
            <p>We have adopted this Privacy Policy, which determines how we are processing the information collected by EdTraining, which also provides the reasons why we must collect certain personal data about you. Therefore, you must read this Privacy Policy before using EdTraining website.</p>
            <p>We take care of your personal data and undertake to guarantee its confidentiality and security.</p>

            <section>
              <h2 className="text-2xl font-bold text-slate-800 mb-3">Personal information we collect</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-800 mb-3">Why do we process your data?</h2>
            ...
            <section>
              ...
              <p>We do not offer refunds for any services provided. We appreciate your understanding.</p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-slate-800 mb-3">Shipping Not Applicable</h2>
              <p>Shipping is not applicable to the services we provide.</p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-slate-800 mb-3">Changes to This Privacy Policy</h2>
